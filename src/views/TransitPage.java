...
public class TransitPage extends JFrame implements ActionListener, ItemListener{
    ...
    public TransitPage(String firstPlayerName) throws IOException {
        this.setLayout(null);
        ...
        ImageIcon ironmanPhoto = new ImageIcon("ironman.png");
        ...
        ImageIcon captainAmericaPhoto = new ImageIcon("captainAmerica.png");
        ...
        ImageIcon drStrangePhoto = new ImageIcon("drStrange.jpg");
        ...
        ImageIcon deadpoolPhoto = new ImageIcon("deadpool.jpg");
        ...
        ImageIcon electroPhoto = new ImageIcon("electro.jpg");
        ...
        ImageIcon GhostRiderPhoto = new ImageIcon("Ghost-Rider.png");
        ...
        ImageIcon HelaPhoto = new ImageIcon("hela.jpg");
        ...
        ImageIcon HulkPhoto = new ImageIcon("hulk.png");
        ...
        ImageIcon IcemanPhoto = new ImageIcon("iceman.png");
        ...
        ImageIcon LokiPhoto = new ImageIcon("loki.png");
        ...
        ImageIcon QuickSilverPhoto = new ImageIcon("quicksilver.png");
        ...
        ImageIcon SpidermanPhoto = new ImageIcon("Spiderman.png");
        ...
        ImageIcon ThorPhoto = new ImageIcon("Thor.jpg");
        ...
        ImageIcon VenomPhoto = new ImageIcon("venom.png");
        ...
        ImageIcon YellowJacketPhoto = new ImageIcon("YellowJacket.jpg");
        ...
        JLabel welcome = new JLabel("<html><p>Hello " + firstPlayerName + ", Please choose 2 champions to start with");
    ...
    public void itemStateChanged(ItemEvent e) {
        ...
        if (i == 3) {
            Player first = new Player(this.firstPlayerName);
            ...
            int indexOfLeader = JOptionPane.showOptionDialog(null, "Please select your leader",
                    ...
                    options, 0);
            first.setLeader(first.getTeam().get(indexOfLeader));
            String secondPlayerName = JOptionPane.showInputDialog("Dear Player2, What should we call you with?");
            try {
                this.dispose();
                SecondTransitPage s = new SecondTransitPage(secondPlayerName,first);
